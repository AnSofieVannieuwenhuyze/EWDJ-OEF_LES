...
@Entity
@NamedQueries({@NamedQuery(name = "Campus.findAll", query = "SELECT c FROM Campus c"), @NamedQuery(name = "Campus.findByName", 
query = 
"SELECT c FROM Campus c WHERE c.campusNaam = :naam")})
public class Campus implements Serializable {
    ...
    protected Campus() { // Nodig voor JPA-ORM tool
